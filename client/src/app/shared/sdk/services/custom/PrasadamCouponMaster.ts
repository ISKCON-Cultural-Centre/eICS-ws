...
/**
 * Api services for the `PrasadamCouponMaster` model.
 */
@Injectable()
export class PrasadamCouponMasterApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id PrasadamCouponMaster id
   *
   ...
   * This usually means the response is a `PrasadamCouponMaster` object.)
   * </em>
   */
  public getFkPrasadamCouponMasterDepartmentEvent1rel(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    ...
    "/PrasadamCouponMasters/:id/fkPrasadamCouponMasterDepartmentEvent1rel";
