...
/**
 * Api services for the `PledgePayment` model.
 */
@Injectable()
export class PledgePaymentApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public getFkPledgePaymentPledge1rel(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PledgePayments/:id/fkPledgePaymentPledge1rel";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
