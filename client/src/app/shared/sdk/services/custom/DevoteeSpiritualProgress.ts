...
export class DevoteeSpiritualProgressApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id DevoteeSpiritualProgress id
   *
  ...
  /**
   * Fetches belongsTo relation fkDevoteeSpiritualFamilyGuru1rel.
   *
   * @param {any} id DevoteeSpiritualProgress id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getFkDevoteeSpiritualFamilyGuru1rel(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/DevoteeSpiritualProgresses/:id/fkDevoteeSpiritualFamilyGuru1rel";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
