...
export class DepartmentApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} fk Foreign key for announcements
   *
   ...
   * </em>
   */
  public findByIdAnnouncements(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Departments/:id/announcements/:fk";
   ...
   */
  public destroyByIdAnnouncements(id: any, fk: any, customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public updateByIdAnnouncements(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public getFkDepartmentDevotee1rel(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Departments/:id/fkDepartmentDevotee1rel";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public getFkDepartmentTemple1rel(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Departments/:id/fkDepartmentTemple1rel";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries announcements of Department.
   *
   * @param {any} id Department id
   *
   * @param {object} filter 
   ...
   * </em>
   */
  public getAnnouncements(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public createAnnouncements(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
   ...
   * This method returns no data.
   */
  public deleteAnnouncements(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Departments/:id/announcements";
    let _routeParams: any = {
  ...
  /**
   * Counts announcements of Department.
   *
   * @param {any} id Department id
   *
   ...
   *  - `count` – `{number}` - 
   */
  public countAnnouncements(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Departments/:id/announcements/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createManyAnnouncements(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Departments/:id/announcements";
    let _routeParams: any = {
