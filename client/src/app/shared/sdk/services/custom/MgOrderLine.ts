...
/**
 * Api services for the `MgOrderLine` model.
 */
@Injectable()
export class MgOrderLineApi extends BaseLoopBackApi {
  ...
  /**
   * Fetches belongsTo relation fkBookMarathonOrderDetailBook1rel.
   *
   * @param {any} id MgOrderLine id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getFkBookMarathonOrderDetailBook1rel(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
