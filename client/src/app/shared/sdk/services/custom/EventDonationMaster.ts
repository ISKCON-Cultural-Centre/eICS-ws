...
export class EventDonationMasterApi extends BaseLoopBackApi {
  ...
  /**
   * Fetches belongsTo relation fkEventDonationMasterDonationCategoryMaster1rel.
   *
   ...
   * </em>
   */
  public getFkEventDonationMasterDonationCategoryMaster1rel(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/EventDonationMasters/:id/fkEventDonationMasterDonationCategoryMaster1rel";
